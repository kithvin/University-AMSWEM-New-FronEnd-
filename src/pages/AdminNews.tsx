      ...
      <div className="p-4 sm:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
          {newsList.map((news, index) => (
            <div 
              key={index} 
              className="bg-white shadow-lg rounded-lg p-4 sm:p-6 hover:shadow-xl transition-shadow duration-300">
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center px-4">
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-full w-full sm:max-w-lg">
              <h2 className="text-2xl font-bold mb-4 text-center">Create News</h2>
              <form>
                <input 
                  type="text" 
                  placeholder="Author Name" 
                  className="w-full p-2 sm:p-3 border rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <input 
                  type="text" 
                  ...
                  className="w-full p-2 sm:p-3 border rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <h2 className="mb-4 font-bold ">Publish Date</h2>
                <input 
                  type="date" 
                  className="w-full p-2 sm:p-3 border rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
